...
public class CollectionTerritory {
    ...
    private void initializeHouseholds() {
        ...
        for (int i = 0; i < numberOfHouseholds; i++) {
            Household hh = new Household(i, this, householdSize);
            households.add(hh);
        }
        
        System.err.println("Territory " + ident + ": Created " + numberOfHouseholds + 
                          " households (population=" + sizePop + 
    ...
    public void iterate(int year) {
        // Calculate infrastructure and behavioral sigmoid curves
        ...
        // Original SD model calculations (unchanged)
        ...
        // NEW: Distribute aggregate flows to households
    ...
    public void collect(int y) {
        ...
        Bsf[y] = (αsf[y] * Bpf[y]) + Ucf[y]; // Food waste + composting surplus
