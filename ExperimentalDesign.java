...
class ExperimentalDesign {
    ...
    public void lectureEntree(String fileName, int ligne, int frequenceSauvegarde, boolean entete) {
        try {
            ...
            st.nextToken();
            int nbParamToDescribeSubTerritory = 25; // CHANGED from 24
...
// NEW: Read household size parameter
            paramSubT[24] = (double) st.nval; // household size (e.g., 2.1)
            st.nextToken();
            
            // Copy parameters to main array
